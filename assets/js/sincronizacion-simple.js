...
// window.guardarConfigFuncionales = guardarConfigFuncionales; // REMOVIDO: Ya está en app.js
// window.cargarConfigFuncionales = cargarConfigFuncionales; // REMOVIDO: Ya está en app.js
